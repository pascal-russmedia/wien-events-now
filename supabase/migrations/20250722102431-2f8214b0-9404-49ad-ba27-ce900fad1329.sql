-- Remove added_by_email from get_expanded_future_events function
...
CREATE OR REPLACE FUNCTION public.get_expanded_future_events(
  region_filter text DEFAULT 'Vorarlberg'::text, 
  category_filter text DEFAULT NULL::text, 
  subcategory_filter text DEFAULT NULL::text, 
  start_date_filter date DEFAULT NULL::date, 
  end_date_filter date DEFAULT NULL::date, 
  single_date_filter date DEFAULT NULL::date, 
