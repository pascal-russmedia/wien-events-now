...
DROP FUNCTION IF EXISTS public.get_internal_events_grouped();
DROP FUNCTION IF EXISTS public.get_internal_events_grouped(integer);
DROP FUNCTION IF EXISTS public.get_internal_events_grouped(integer, integer);
DROP FUNCTION IF EXISTS public.get_internal_events_grouped(integer, integer, text);

-- Create single clean version without search
CREATE FUNCTION public.get_internal_events_grouped(
