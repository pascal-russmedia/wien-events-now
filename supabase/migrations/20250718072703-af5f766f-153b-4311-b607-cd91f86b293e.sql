-- Drop and recreate get_export_events function to include city field
DROP FUNCTION IF EXISTS public.get_export_events(date, text, text, text);
...
BEGIN
  ...
  SELECT 
    ...
    e.city, e.host, e.address, e.state, e.popularity_score, e.trust_score, e.dates,
