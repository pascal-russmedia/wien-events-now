-- Fix case sensitivity in both functions
DROP FUNCTION IF EXISTS public.get_future_events_by_state(text, integer, integer);
DROP FUNCTION IF EXISTS public.get_past_events_by_state(text, integer, integer);

-- Create updated function for future events with case-insensitive state filtering
...
-- Create updated function for past events with case-insensitive state filtering
